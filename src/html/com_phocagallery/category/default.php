...
?>
<div id="phocagallery-responsive" class="pg-category-view' <?php echo $this->params->get('pageclass_sfx'); ?> ' pg-cv">
...
// Category Description
   if (isset($this->category->description) && $this->category->description != '') {
      echo '<div class="large-12">' . JHTML::_('content.prepare', $this->category->description) . '</div>' . "\n";
   }

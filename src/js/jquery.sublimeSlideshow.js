/**
 * @see http://www.jqueryscript.net/slideshow/Fullscreen-Background-Image-Slideshow-Plugin-with-jQuery.html
 * http://www.jqueryscript.net/download/Fullscreen-Background-Image-Slideshow-Plugin-with-jQuery.zip
 */
 ...
 *       duration: 6,
 *       fade: 2,
 *       overlay: "images/pattern.png" //|false
 *   });
 * </code>
 */
(function($) {
   ...
   var $backgrounds = $("<ul class='sm-slider'></ul>"),
           methods = {
              ...
              mkcss: function(bgCount, duration, fade) {
                 ...
                 otherCSS = ".sm-slider,.sm-slider:after { margin: 0;padding: 0;list-style: none;position: fixed;width: 100%;height: 100%;top: 0px;left: 0px;z-index: -1; }";
                 if (this.options.overlay === false) {
                    otherCSS += ".sm-slider:after { content: '';background: transparent; z-index: 0; }.sm-slider li span { width: 100%;height: 100%;position: absolute;top: 0px;left: 0px;color: transparent;background-size: cover;background-position: 50% 50%;background-repeat: none;opacity: 0;z-index: 0;animation: imageAnimation {0}s linear infinite 0s; }.sm-slider li div { z-index: 1000;position: absolute;bottom: 30px;left: 0px;width: 100%;text-align: center;opacity: 0;color: #fff;animation: titleAnimation {0}s linear infinite 0s; }".format(total_time);
                 } else {
              ...
              addPrefix: function(css) {
                 ...
                 css = css.replace(keyframes, "@-webkit-$1 @-moz-$1 @-ms-$1 @-o-$1 @$1")
